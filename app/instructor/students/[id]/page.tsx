      ...
      <section className="bg-white rounded-sm p-6 border border-slate-100 shadow-[0_4px_20px_rgba(0,0,0,0.02)] flex flex-col md:flex-row items-center md:items-start gap-6">
        ...
        <div className="flex-1 text-center md:text-left">
          <div className="flex flex-col md:flex-row md:items-center gap-2">
            ...
            <span className="inline-block bg-blue-50 border border-blue-100 text-blue-600 text-[10px] font-bold px-2.5 py-0.5 rounded-full uppercase tracking-wider mx-auto md:mx-0">
        ...
        <div className="bg-white p-6 rounded-sm border border-slate-100 shadow-[0_4px_20px_rgba(0,0,0,0.02)] flex flex-col justify-between">
          <div>
            ...
            <div className="flex items-baseline justify-between mb-2">
              <span className="text-3xl font-extrabold text-blue-600">{student.progress}%</span>
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <span className={`px-2 py-0.5 rounded-full text-[9px] font-bold uppercase ${
                    c.status === "Confirmada" ? "bg-blue-50 text-blue-600 border border-blue-100" :
