...
export default function Home() {
  ...
  const stats = [
    { value: "+18.000", label: "Aulas Concluídas", desc: "Aulas agendadas e gerenciadas sem planilhas ou burocracia." },
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-white flex flex-col justify-between relative overflow-x-hidden font-sans transition-colors duration-300">
      ...
      <div className="absolute top-[-10%] left-[-15%] w-[80%] h-[60%] bg-blue-600/10 dark:bg-blue-600/20 rounded-full blur-[140px] pointer-events-none z-0 animate-pulse-slow" />
      <div className="absolute bottom-[20%] right-[-10%] w-[60%] h-[70%] bg-rose-500/10 dark:bg-rose-500/15 rounded-full blur-[140px] pointer-events-none z-0 animate-pulse-slow" />

      {/* Header */}
      <Header />

      {/* Hero Section */}
      <section className="relative pt-16 pb-20 md:pt-28 md:pb-32 px-6 flex flex-col items-center text-center z-10">
        <div className="max-w-4xl mx-auto flex flex-col items-center">
          
          {/* Eyebrow / Tagline - Limited to 1 in hero stack */}
          ...
          {/* CTAs */}
          <div className="flex flex-col sm:flex-row gap-4 mt-8 w-full justify-center animate-fade-in-up delay-200">
            <button 
        ...
        {/* SaaS Dashboard Preview - High-Contrast Z-Axis Overlap */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-left">
                ...
                <div className="flex flex-col gap-2">
                  <div className="p-2.5 bg-blue-500/5 border-l-4 border-blue-600 rounded-sm flex items-center justify-between text-xs">
                    <div>
                      ...
                      <p className="text-[10px] text-slate-500 dark:text-slate-400">Ponto: Estação Metrô Tucuruvi</p>
                    </div>
                  ...
                  <div className="p-2.5 bg-rose-500/5 border-l-4 border-rose-500 rounded-sm flex items-center justify-between text-xs">
                    <div>
                      ...
                      <p className="text-[10px] text-slate-500 dark:text-slate-400">Ponto: Praça Central de Campinas</p>
                    </div>
                    <span className="px-2 py-0.5 bg-rose-500/10 text-rose-500 dark:text-rose-400 font-bold text-[9px] uppercase tracking-wider rounded-sm">Confirmar WhatsApp?</span>
                  </div>
                  ...
                  <div className="p-2.5 bg-slate-500/5 border-l-4 border-slate-400 rounded-sm flex items-center justify-between text-xs">
                    <div>
                      ...
                      <p className="text-[10px] text-slate-550 dark:text-slate-500">Ponto: Centro de Treinamento</p>
                    </div>
                    <span className="px-2 py-0.5 bg-slate-200 dark:bg-slate-800 text-slate-550 dark:text-slate-400 font-bold text-[9px] uppercase tracking-wider rounded-sm">Finalizada</span>
                  </div>
                </div>
              </div>
              ...
              <div className="p-4 border border-slate-200 dark:border-slate-800 rounded-sm flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex items-center gap-2.5 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-[9px] text-slate-550 dark:text-slate-450 font-medium">Exame previsto: 18/07</p>
                    </div>
                  </div>
                ...
                <div className="border-t border-slate-100 dark:border-slate-800 pt-3 mt-3">
                  ...
                  <p className="text-[10px] leading-tight text-slate-650 dark:text-slate-400 italic font-medium">&ldquo;Excelente controle de embreagem em aclive. Precisa revisar baliza na próxima aula.&rdquo;</p>
                </div>
              </div>
      ...
      {/* Stats Section */}
      <section className="py-16 border-t border-b border-slate-200 dark:border-slate-900 bg-white dark:bg-slate-950/60 relative z-10 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, idx) => (
              <div 
                key={idx} 
                className="bg-slate-50 dark:bg-slate-900/30 border-2 border-slate-100 dark:border-slate-900 p-6 rounded-sm flex flex-col gap-2 hover:border-blue-600/30 hover:-translate-y-1 transition-all duration-300 group"
              >
                <span className="text-3xl md:text-5xl font-black text-blue-600 dark:text-blue-500 font-mono group-hover:scale-105 transition-transform duration-300 inline-block origin-left">{stat.value}</span>
                <h4 className="font-black text-xs uppercase tracking-wider text-slate-800 dark:text-slate-200">{stat.label}</h4>
                <p className="text-xs text-slate-500 dark:text-slate-500 leading-relaxed font-medium">{stat.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Features Section - Fragmented asymmetric grid */}
      <section id="funcionalidades" className="py-24 px-6 max-w-7xl mx-auto w-full z-10 scroll-mt-20">
        <div className="max-w-2xl mb-16 text-left">
          <h3 className="text-3xl md:text-5xl font-black tracking-tighter uppercase text-slate-900 dark:text-white animate-fade-in-up">
            TUDO QUE VOCÊ PRECISA PARA GERENCIAR SUA AUTOESCOLA OU AULAS PARTICULARES
          </h3>
          <p className="text-slate-500 dark:text-slate-400 mt-4 text-sm max-w-xl font-medium leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* Asymmetric block 1: Highlight double width */}
          <div className="md:col-span-2 bg-slate-900 text-white p-8 border-2 border-blue-600 rounded-sm flex flex-col justify-between gap-8 relative overflow-hidden group shadow-lg">
            ...
            <div>
              <button 
                ...
                className="inline-flex items-center gap-1.5 text-xs font-black uppercase text-rose-450 hover:text-rose-300 transition-colors group cursor-pointer"
              >
          ...
          {/* Asymmetric block 2: Normal width */}
          ...
          {/* Asymmetric block 3: Normal width */}
          ...
          {/* Asymmetric block 4: Highlight double width */}
          <div className="md:col-span-2 bg-slate-50 dark:bg-slate-900/40 border-2 border-slate-200 dark:border-slate-800 p-8 rounded-sm flex flex-col justify-between gap-8 group">
            <div>
              <div className="w-12 h-12 rounded-sm bg-amber-500/10 dark:bg-amber-500/5 flex items-center justify-center text-amber-500 border border-amber-500/20 mb-6">
            ...
            <div>
              <span className="px-3 py-1 bg-amber-500/10 text-amber-600 dark:text-amber-500 font-bold font-mono text-[9px] uppercase tracking-wider rounded-sm border border-amber-500/20">
      ...
      {/* Pricing Section - THE CORE CONVERSION GATE */}
      <section id="planos" className="py-24 border-t border-slate-200 dark:border-slate-900 bg-white dark:bg-slate-950/20 relative z-10 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-6">
            ...
            {plans.map((plan, idx) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-550 dark:text-slate-450 mb-6 font-medium leading-snug">{plan.desc}</p>
                  ...
                  <ul className="space-y-3.5 border-t border-slate-200 dark:border-slate-800 pt-6">
                    {plan.features.map((feat, fIdx) => (
                      <li key={fIdx} className="flex items-start gap-2.5 text-xs text-slate-650 dark:text-slate-350">
      ...
      <section className="py-24 border-t border-slate-200 dark:border-slate-900 px-6 max-w-7xl mx-auto w-full z-10 transition-colors duration-300">
        <div className="max-w-2xl mb-16 text-left">
          <h3 className="text-3xl md:text-5xl font-black tracking-tighter uppercase text-slate-900 dark:text-white">
            QUEM USA A PISTA APROVA E RECOMENDA
          </h3>
          <p className="text-slate-500 dark:text-slate-400 mt-3 text-sm font-medium">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((test, idx) => (
            <div 
              key={idx} 
              className="bg-white dark:bg-slate-900 border-2 border-slate-200 dark:border-slate-900 p-6 rounded-sm flex flex-col justify-between gap-6 hover:border-blue-600/30 transition-all duration-300 shadow-sm"
            >
              <p className="text-xs text-slate-650 dark:text-slate-350 leading-relaxed italic font-medium">
              ...
              <div className="flex items-center gap-3 border-t border-slate-100 dark:border-slate-850 pt-4">
                <Image 
                  ...
                  width={36}
                  height={36}
                  className="w-9 h-9 rounded-sm object-cover border-2 border-blue-500/20"
                />
                <div>
                  <h4 className="font-black text-xs text-slate-900 dark:text-white">{test.name}</h4>
                  <span className="text-[10px] text-rose-500 font-bold block">{test.role}</span>
                </div>
              </div>
            </div>
          ))}
          ...
          {faqs.map((faq, idx) => {
            ...
            return (
              ...
              >
                ...
                {isOpen && (
                  <div className="px-6 pb-5 pt-1 border-t border-slate-100 dark:border-slate-850 bg-slate-50/20 dark:bg-slate-950/30 text-xs text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
                    {faq.answer}
                  </div>
                )}
              </div>
      ...
      {/* Final Call to Action - High Energy Neon Accent Box */}
      <section className="py-16 px-6 max-w-7xl mx-auto w-full z-10 mb-10">
        <div className="bg-slate-900 border-2 border-blue-600 rounded-sm p-8 md:p-16 text-center relative overflow-hidden flex flex-col items-center shadow-xl">
          <div className="absolute inset-0 bg-linear-to-br from-blue-600/20 to-rose-500/10 pointer-events-none animate-pulse-slow" />
          <div className="absolute -top-32 -left-32 w-64 h-64 bg-blue-600/30 rounded-full blur-[80px]" />
          <div className="absolute -bottom-32 -right-32 w-64 h-64 bg-rose-500/20 rounded-full blur-[80px]" />
          ...
          <div className="bg-white dark:bg-slate-900 border-2 border-blue-600 rounded-sm w-full max-w-md p-6 relative shadow-2xl overflow-hidden">
            ...
            {!isSuccess ? (
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <div className="relative">
                      <User className="absolute left-3 top-3.5 w-4 h-4 text-slate-450 dark:text-slate-500" />
                      <input
                        id="lead-name"
                        type="text"
                        required
                        ...
                        className="w-full pl-9 pr-4 py-3 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-xs text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-550 focus:border-blue-600 focus:outline-hidden transition-colors rounded-sm"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <EnvelopeSimple className="absolute left-3 top-3.5 w-4 h-4 text-slate-450 dark:text-slate-500" />
                      <input
                        id="lead-email"
                        type="email"
                        required
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <WhatsappLogo className="absolute left-3 top-3.5 w-4 h-4 text-slate-450 dark:text-slate-500" />
                      <input
                        id="lead-phone"
                        type="tel"
                        required
              ...
              <div className="text-center py-8 flex flex-col items-center justify-center space-y-4">
                ...
                <p className="text-xs text-slate-550 dark:text-slate-450 max-w-xs leading-relaxed font-medium">
