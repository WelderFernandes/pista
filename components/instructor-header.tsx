...
export function InstructorHeader() {
  ...
  return (
    <header className="w-full gap-2 sticky top-0 z-40 bg-white/85 dark:bg-slate-900/85 backdrop-blur-md border-b border-slate-200/50 dark:border-slate-850 flex items-center justify-end px-6 py-3.5 shadow-[0_1px_2px_rgba(0,0,0,0.01)] transition-colors duration-300">
